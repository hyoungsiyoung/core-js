...
// - "beforebegin" – elem 바로 앞에 html을 삽입 (elem 바로 앞에 삽입)
// - "afterbegin" – elem의 첫 번째 자식 요소 바로 앞에 html을 삽입 (elem 안쪽 첫 번째 삽입)
// - "beforeend" – elem의 마지막 자식 요소 바로 다음에 html을 삽입 (elem 안쪽 마지막 삽입)
// - "afterend" – elem 바로 다음에 html을 삽입 (elem 바깥쪽 삽입)
